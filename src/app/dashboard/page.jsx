...
//       if (!user) return; // ইউজার সেশন না আসলে রিটার্ন করবে
...
//         // সুনির্দিষ্টভাবে ID ও Email পাঠানো হচ্ছে
...
//     loadStats();
//   }, [user?.id, user?.email, user?.role]); // অবজেক্টের বদলে নির্দিষ্ট প্রপার্টিকে ডিপেন্ডেন্সিতে দেওয়া হলো
