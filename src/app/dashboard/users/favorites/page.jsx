      ...
      <>
        ...
        <div className="hidden md:block overflow-x-auto rounded-xl border border-gray-200 dark:border-gray-800">
          <table className="w-full text-left text-sm text-gray-600 dark:text-gray-300">
            {/* Header text visibility fixed here */}
            <thead className="bg-gray-100 dark:bg-gray-800 text-xs font-mono uppercase text-gray-800 dark:text-gray-100 border-b border-gray-200 dark:border-gray-700">
              <tr>
            ...
            <tbody className="divide-y divide-gray-100 dark:divide-gray-800/60">
              <AnimatePresence>
                {favorites.map((item) => {
                  ...
                  const title = recipe.title || recipe.name || recipe.recipeTitle || item.title || item.name || "Untitled Recipe";
                  const description = recipe.description || recipe.details || recipe.summary || item.description || "";
                  const category = recipe.category || recipe.recipeCategory || item.category || "General";
                  const image = recipe.image || recipe.photo || item.image || "https://images.unsplash.com/photo-1546069901-ba9599a7e63c";
                  const prepTime = recipe.prepTime || item.prepTime;
                  ...
                  return (
                    ...
                    >
                      ...
                      <td className="py-3 px-4">
                        <span className="text-xs px-2.5 py-1 rounded-full bg-orange-100 dark:bg-orange-950/50 text-orange-600 dark:text-orange-400 font-medium capitalize">
                          {category}
                        </span>
                      </td>
                      ...
                      <td className="py-3 px-4 text-right">
                        <div className="flex items-center justify-end gap-2">
                          <button
                            onClick={() => setSelectedRecipe({ ...recipe, title, description, category, image, prepTime })}
                  ...
                  <div className="flex-1 flex flex-col justify-between">
                    <div>
                      <div className="flex justify-between items-start gap-2">
                        ...
                        <span className="text-[10px] px-2 py-0.5 rounded-full bg-orange-100 dark:bg-orange-950/50 text-orange-600 dark:text-orange-400 font-medium flex-shrink-0 capitalize">
                          {category}
                        </span>
                      </div>
                      ...
                      {prepTime && (
                        <p className="text-[11px] text-gray-400 flex items-center gap-1 mt-1">
                          <FaClock size={10} className="text-orange-500" /> {prepTime} mins
                        </p>
                      )}
                    </div>
      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-xs">
        ...
        >
          ...
          <div className="flex gap-4 items-start pr-6">
            <img
              src={selectedRecipe.image || selectedRecipe.photo}
          ...
          {selectedRecipe.description && (
            <p className="text-xs text-gray-600 dark:text-gray-300 leading-relaxed bg-gray-50 dark:bg-gray-950 p-3 rounded-xl border border-gray-100 dark:border-gray-800">
              {selectedRecipe.description}
            </p>
          )}
