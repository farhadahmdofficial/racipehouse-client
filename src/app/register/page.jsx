      ...
      <form onSubmit={handleRegister} className="space-y-4">
        ...
        <div className="space-y-1">
          ...
          <select
            name="role"
            defaultValue="user"
            className="w-full bg-[#030712] border border-white/10 rounded-xl px-4 py-2.5 text-xs text-white focus:outline-none focus:border-orange-500/60 transition-colors cursor-pointer"
          >
            <option value="user" className="bg-[#090d16] text-white">User</option>
            <option value="admin" className="bg-[#090d16] text-white">Admin</option>
          </select>
        </div>
...
// ২. মূল Export কম্পোনেন্ট যা Suspense Boundary নিশ্চিত করে
const Register = () => {
  return (
...
// //     const { data, error } = await authClient.signUp.email({
// //       ...registerData,
// //       plan: "free", // 💡 ডিফল্ট প্ল্যান সেট করা হলো
// //     });
...
//   try {
//     // 💡 ২. inferAdditionalFields প্লাগইন থাকায় role এবং plan সরাসরি পাস হবে
//     const { data, error } = await authClient.signUp.email({
//       email,
//       password,
//       name,
//       ...(image && { image }),
//       role: role || "user", // 👈 সরাসরি পাস করুন
//       plan: "free",         // 👈 সরাসরি পাস করুন
//     });
...
// //   // 💡 ২. মূল ফর্ম ডাটা থেকে role, plan এবং image বের করে নেওয়া
// //   const { name, email, password, image, role } = registerData;

// //   console.log("Cleaned Signup Data:", registerData);

// //   try {
// //     // 💡 ৩. Better Auth-এর নির্ধারিত স্ট্রাকচারে ডাটা পাঠানো
// //     const { data, error } = await authClient.signUp.email({
// //       email,
// //       password,
// //       name,
// //       ...(image && { image }), // ইমেজ থাকলে পাঠাবে
      
// //       // 🎯 আসল ট্রিক: role এবং plan অবশ্যই additionalFields-এর ভেতর পাঠাতে হবে!
// //       additionalFields: {
// //         role: role || "user", // ফর্মের সিলেক্ট করা 'admin' বা 'user'
...
// //     // Better Auth যদি কোনো এরর অবজেক্ট রিটার্ন করে
// //     if (res?.error) {
...
// //     // 💡 ১. রিডাইরেক্ট পাথ বের করা (যেমন: '/dashboard' বা '/')
// //     const redirectPath = searchParams.get('redirect') || '/';

// //     // 💡 ২. ফ্রন্টএন্ডের ফুল URL তৈরি করা (যেমন: "http://localhost:3000/")
// //     const fullCallbackURL = `${window.location.origin}${
...
// //     const res = await authClient.signIn.social({
// //       provider: 'google',
// //       callbackURL: fullCallbackURL, // 👈 এখানে ফুল URL পাঠানো হচ্ছে
// //     });
...
//   return (<div className="min-h-screen bg-[#030712] text-white px-4 py-12 flex items-center justify-center relative overflow-hidden">
//   {/* 🔮 Warm Culinary Orange Glow Grid */}
//   <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 h-[600px] w-[600px] rounded-full bg-orange-500/10 blur-[160px] pointer-events-none" />
...
//       {/* 💡 Field 3: Select Role (User / Admin) - নতুন যুক্ত করা হলো */}
//       <div className="space-y-1">
//         <label className="font-mono text-[10px] uppercase tracking-widest text-gray-400">
//           Select Role
//         </label>
